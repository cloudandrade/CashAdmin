  ...
  return (
    <div className="mx-auto w-full max-w-lg px-4 pb-10 pt-4">
      ...
      <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
        ...
        As despesas do mês fechado passam a aparecer como &quot;Em aberto&quot;
        para você acompanhar o mês seguinte.
      </p>
        ...
        <ul className="mt-6 flex flex-col gap-2">
          {statements.map((s) => {
            ...
            return (
              <li
                key={s._id.toString()}
                className="rounded-xl border border-zinc-200 bg-white px-3 py-3 dark:border-zinc-700 dark:bg-zinc-900"
              >
